...
int main()
{
    ...
    Font fuente_titulo = LoadFontEx("Assets/Gilroy-ExtraBold.otf", 64, NULL, 0);
    Font fuente1 = LoadFontEx("Assets/AlteHaasGroteskBold.ttf", 64, NULL, 0);
    Font fuente2 = LoadFontEx("Assets/CoolveticaRgCond.otf", 64, NULL, 0);
